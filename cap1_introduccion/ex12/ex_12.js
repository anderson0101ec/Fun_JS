...
switch (valor) {
    case 1:
        ...
        break;
    case 2:
        document.writeln('Ingresarte el numero', valor);
        break;
    case 3:
        document.writeln('Ingresate el numero', valor);
        break;
    default:
...
let color;
color = parseInt(prompt('Ingrese el 1 para el Azul, El 2 para Amarillo y el 3 para el color naranja'));
...
switch (color) {
    case 1:
        ...
        break;
    case 2:
        document.writeln('Ingresarte el color Amarillo', color);
        break;
    case 3:
        document.writeln('Ingresate el color Naranja', color);
        break;
    default:
        document.writeln('El color digitado esta fuera del rango solicitado');
        break;
}
